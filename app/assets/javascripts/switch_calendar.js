const displayCalendar = () => {                                             //文字列を数値に変換
  const monthCalendarElement = document.getElementById("month_calendar");   // 要素を取得
  ...
  window.addEventListener("click", switchCalendar); //addEventListenerで登録
}
